...
print("[^1Serveur^0] : ^4BZH RP 2.0^0")
print("[^1Auteur^0] : ^4BZH Corporation®^0")
---round
---@param num number
                ...
                if RageUI.CurrentMenu() then
                    ...
                    --if (RageUI.CurrentMenu.WidthOffset == 100) then
                        if Glare then
							...
							---@type number
							local GlareX = RageUI.CurrentMenu.X / 1920 + (RageUI.CurrentMenu.SafeZoneSize.X / (64.399 - (RageUI.CurrentMenu.WidthOffset * 0.065731)))--1860
                            ---@type number
